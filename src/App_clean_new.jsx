        ...
        <nav className="mt-6 px-6">
          <div className="space-y-2">
            ...
            <Link 
              ...
              className="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
            >
              <span className="mr-3">📄</span> Formulário
            </Link>
            <Link 
              to="/projeto" 
              className="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Saldo de Horas</p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Horas Hoje</p>
                <p className="text-2xl font-bold text-blue-600">07:45</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Projeto Atual</p>
                <p className="text-lg font-semibold text-gray-900">YourTime v2.0</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-semibold text-green-600">Trabalhando</p>
              </div>
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-gray-900 group-hover:text-green-700">Registrar Ponto</p>
                  <p className="text-sm text-gray-500">Entrada/Saída</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-gray-900 group-hover:text-red-700">Formulário</p>
                  <p className="text-sm text-gray-500">Ajustar ponto</p>
                </div>
              </Link>
            </div>
