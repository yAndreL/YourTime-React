...
function HistoricoApontamento() {
  ...
  return <MainLayout title={t('history.title')} subtitle={t('history.subtitle')}>
      {!loading && filteredApontamentos.length > 0 && <div className="mb-4 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-4 gap-3 items-end mb-4">
            <div>
              ...
              <input type="date" id="dataInicio" name="dataInicio" value={filters.dataInicio} onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm" />
            </div>
            <div>
              <label htmlFor="dataFim" className="block text-sm font-medium text-gray-700 mb-1">
                {t('history.endDate')}
              </label>
              <input type="date" id="dataFim" name="dataFim" value={filters.dataFim} onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm" />
            </div>
            <div>
              <label htmlFor="projeto" className="block text-sm font-medium text-gray-700 mb-1">
                Projeto:
              </label>
              <select id="projeto" name="projeto" value={filters.projeto} onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
        ...
        <div className="space-y-3">
          {showSkeleton ? <div className="bg-gray-50 rounded-lg border border-gray-300 p-6 text-center">
              <p className="text-gray-500">{t('history.loadingRecords')}</p>
            </div> : filteredApontamentos.length === 0 ? <div className="bg-gray-50 rounded-lg border border-gray-300 p-6 text-center">
          ...
          return <div key={apontamento.id} className="bg-white rounded-lg shadow-sm border border-gray-300 p-4">
                ...
                {apontamento.anotacoes && <div className="mt-2 bg-gray-50 rounded p-2 border border-gray-200">
