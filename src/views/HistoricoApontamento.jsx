...
function HistoricoApontamento() {
  ...
  return <MainLayout title={t('history.title')} subtitle={t('history.subtitle')}>
      {!loading && filteredApontamentos.length > 0 && <div className="mb-4 yt-card p-3 sm:p-4">
          <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">{t('history.periodSummary')}</h3>
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            <div className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 rounded-lg p-2 sm:p-4 text-center">
              <div className="text-xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400">{filteredApontamentos.length}</div>
              <div className="text-xs sm:text-sm text-blue-700 dark:text-blue-200 font-medium">{t('history.records')}</div>
            </div>
            <div className="bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800 rounded-lg p-2 sm:p-4 text-center">
              ...
              <div className="text-xs sm:text-sm text-green-700 dark:text-green-200 font-medium">{t('history.totalWorked')}</div>
            </div>
      ...
      <div className="yt-card p-4">
          <form onSubmit={handleSearch} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 items-end mb-4">
            <div>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-3 pb-2 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      <h3 className="text-sm sm:text-base font-bold text-gray-800 dark:text-gray-100">{formatDate(apontamento.data)}</h3>
