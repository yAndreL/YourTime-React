...
function Configuracoes() {
  ...
  return <MainLayout title={t('settings.title')} subtitle={t('settings.subtitle')}>
      <div className="max-w-4xl mx-auto">
        <div className="yt-card shadow-md p-8">
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 yt-inset rounded-lg border border-gray-200/80 dark:border-gray-700/80">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-blue-100 dark:bg-blue-950/50 rounded-lg flex items-center justify-center">
                      <FiMail className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                    </div>
                    <div>
                      <p className="font-medium text-gray-900 dark:text-gray-100">{t('settings.emailReports')}</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{t('settings.emailReportsDesc')}</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 yt-inset rounded-lg border border-gray-200/80 dark:border-gray-700/80">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 dark:text-gray-100">{t('settings.reminderRecord')}</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{t('settings.reminderRecordDesc')}</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 yt-inset rounded-lg border border-gray-200/80 dark:border-gray-700/80">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 dark:text-gray-100">{t('settings.includeCharts')}</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{t('settings.includeChartsDesc')}</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex gap-4 justify-center">
            <button type="button" onClick={handleSalvar} disabled={isSaving} className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold py-3 px-6 rounded-lg transition-colors flex items-center gap-2">
              {isSaving ? <>
            ...
            <button type="button" onClick={() => setShowConfirmModal(true)} disabled={isSaving} className="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 disabled:bg-gray-200 dark:disabled:bg-gray-700 text-gray-700 dark:text-gray-100 font-bold py-3 px-6 rounded-lg transition-colors">
