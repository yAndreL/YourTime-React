export const translations = {
  'pt-BR': {
    ...
    painel: {
      ...
      dayCompleted: 'Jornada Encerrada',
      noRecord: 'Sem Registro Hoje',
      page: 'Página',
      of: 'de',
      ...
      projectDeselected: 'Projeto desmarcado',
      entryRegistered: 'Entrada registrada',
      entry2Registered: 'Entrada 2 registrada',
      exitRegistered: 'Saída registrada',
      exit2Registered: 'Saída 2 registrada',
      timeEntryRegistered: 'Registro de ponto',
      errorLoadingProjects: 'Não foi possível carregar os projetos',
      checkInternetConnection: 'Verifique a conexão com a internet',
    ...
    irregularidades: {
      ...
      subtitulo: 'Visão geral de atrasos, faltas e inconsistências',
      atrasos: 'Atrasos',
      faltas: 'Faltas',
      faltaSingular: 'falta',
      faltaPlural: 'faltas',
      ...
      semPontoHoje: 'Sem ponto hoje',
      todosComPonto: 'Todos os funcionários registraram ponto hoje',
      rankingFaltas: 'Ranking de Faltas',
      rankingAtrasos: 'Ranking de Atrasos',
      semFaltas: 'Nenhuma falta no período',
    ...
    exportacao: {
      ...
      excelChartTip: 'Dica: Selecione as colunas Status e Quantidade acima e crie um Gráfico de Pizza!',
      totalHoursSummary: 'Resumo Total de Horas',
      tip: 'Dica',
      pdfErrorTip: 'Se o erro persistir, verifique sua conexão com a internet e tente novamente. Para mais informações, consulte o código de erro na documentação.',
      observations: 'Observações',
    ...
    batida: {
      titulo: 'Batida de Ponto',
      subtitulo: 'Registre sua entrada e saída',
      iniciarJornada: 'Iniciar Jornada',
      registrarPausa: 'Pausar',
      ouEncerrar: 'ou encerrar jornada',
      retomar: 'Retomar',
      encerrarJornada: 'Encerrar Jornada',
      jornadaEncerrada: 'Jornada Encerrada',
      aguardandoInicio: 'Aguardando início da jornada',
      emTrabalho: 'Em trabalho',
      emPausa: 'Em intervalo',
      jornadaFinalizada: 'Jornada finalizada',
      ...
      retorno: 'Retorno',
      saida: 'Saída',
      entradaSucesso: 'Entrada registrada com sucesso!',
      pausaSucesso: 'Pausa registrada com sucesso!',
      retornoSucesso: 'Retorno registrado com sucesso!',
      saidaSucesso: 'Saída registrada com sucesso!',
      erroGenerico: 'Erro ao registrar batida',
      geoError: 'Não foi possível capturar a localização. A batida será registrada sem GPS.',
  ...
  'en-US': {
    ...
    painel: {
      ...
      projectDeselected: 'Project deselected',
      entryRegistered: 'Entry registered',
      entry2Registered: 'Entry 2 registered',
      exitRegistered: 'Exit registered',
      exit2Registered: 'Exit 2 registered',
      timeEntryRegistered: 'Time entry',
      errorLoadingProjects: 'Could not load projects',
    ...
    irregularidades: {
      ...
      subtitulo: 'Overview of tardiness, absences and inconsistencies',
      atrasos: 'Late Arrivals',
      faltas: 'Absences',
      faltaSingular: 'absence',
      faltaPlural: 'absences',
      saidasAntecipadas: 'Early Departures',
      horasExtras: 'Overtime',
      semPontoHoje: 'No clock-in today',
      todosComPonto: 'All employees clocked in today',
      rankingFaltas: 'Absence Ranking',
      rankingAtrasos: 'Tardiness Ranking',
      semFaltas: 'No absences in the period',
    ...
    exportacao: {
      ...
      excelChartTip: 'Tip: Select the Status and Quantity columns above and create a Pie Chart!',
      totalHoursSummary: 'Total Hours Summary',
      tip: 'Tip',
      pdfErrorTip: 'If the error persists, check your internet connection and try again. For more information, see the error code in the documentation.',
      observations: 'Observations',
      rawData: 'Raw data',
      notes: 'Notes',
      csvButtonLabel: 'CSV',
    ...
    batida: {
      titulo: 'Clock In/Out',
      subtitulo: 'Record your entry and exit',
      iniciarJornada: 'Start Shift',
      registrarPausa: 'Pause',
      ouEncerrar: 'or end shift',
      retomar: 'Resume',
      encerrarJornada: 'End Shift',
      jornadaEncerrada: 'Shift Ended',
      aguardandoInicio: 'Waiting to start shift',
      emTrabalho: 'Working',
      emPausa: 'On break',
      jornadaFinalizada: 'Shift completed',
      trabalhado: 'Worked',
      pausas: 'Breaks',
      ...
      retorno: 'Resume',
      saida: 'Clock Out',
      entradaSucesso: 'Clock in recorded successfully!',
      pausaSucesso: 'Break recorded successfully!',
      retornoSucesso: 'Resume recorded successfully!',
      saidaSucesso: 'Clock out recorded successfully!',
      erroGenerico: 'Error recording time',
      geoError: 'Could not capture location. The record will be saved without GPS.',
  ...
  'es-ES': {
    ...
    painel: {
      ...
      working: 'Trabajando',
      onBreak: 'En Descanso',
      dayCompleted: 'Jornada Terminada',
      ...
      projectDeselected: 'Proyecto deseleccionado',
      entryRegistered: 'Entrada registrada',
      entry2Registered: 'Entrada 2 registrada',
      exitRegistered: 'Salida registrada',
      exit2Registered: 'Salida 2 registrada',
      timeEntryRegistered: 'Registro de hora',
      errorLoadingProjects: 'No fue posible cargar los proyectos',
      checkInternetConnection: 'Compruebe la conexión a internet',
    ...
    irregularidades: {
      ...
      subtitulo: 'Visión general de retrasos, faltas e inconsistencias',
      atrasos: 'Retrasos',
      faltas: 'Faltas',
      faltaSingular: 'falta',
      faltaPlural: 'faltas',
      saidasAntecipadas: 'Salidas Anticipadas',
      horasExtras: 'Horas Extra',
      semPontoHoje: 'Sin registro hoy',
      todosComPonto: 'Todos los empleados registraron asistencia hoy',
      rankingFaltas: 'Ranking de Faltas',
      rankingAtrasos: 'Ranking de Retrasos',
      semFaltas: 'Ninguna falta en el período',
    ...
    exportacao: {
      ...
      excelChartTip: 'Consejo: ¡Seleccione las columnas Estado y Cantidad arriba y cree un Gráfico de Torta!',
      totalHoursSummary: 'Resumen Total de Horas',
      tip: 'Consejo',
      pdfErrorTip: 'Si el error persiste, compruebe su conexión a internet e intente de nuevo. Para más información, consulte el código de error en la documentación.',
      observations: 'Observaciones',
    ...
    batida: {
      titulo: 'Fichar',
      subtitulo: 'Registre su entrada y salida',
      iniciarJornada: 'Iniciar Jornada',
      registrarPausa: 'Pausar',
      ouEncerrar: 'o finalizar jornada',
      retomar: 'Reanudar',
      encerrarJornada: 'Finalizar Jornada',
      jornadaEncerrada: 'Jornada Finalizada',
      aguardandoInicio: 'Esperando inicio de jornada',
      emTrabalho: 'Trabajando',
      emPausa: 'En descanso',
      jornadaFinalizada: 'Jornada completada',
      ...
      retorno: 'Reanudación',
      saida: 'Salida',
      entradaSucesso: '¡Entrada registrada con éxito!',
      pausaSucesso: '¡Pausa registrada con éxito!',
      retornoSucesso: '¡Reanudación registrada con éxito!',
      saidaSucesso: '¡Salida registrada con éxito!',
      erroGenerico: 'Error al registrar fichaje',
      geoError: 'No se pudo capturar la ubicación. El registro se guardará sin GPS.',
  ...
  'fr-FR': {
    ...
    painel: {
      ...
      onBreak: 'En Pause',
      dayCompleted: 'Journée Terminée',
      noRecord: 'Aucun Enregistrement Aujourd\'hui',
      page: 'Page',
      of: 'de',
      ...
      projectDeselected: 'Projet désélectionné',
      entryRegistered: 'Entrée enregistrée',
      entry2Registered: 'Entrée 2 enregistrée',
      exitRegistered: 'Sortie enregistrée',
      exit2Registered: 'Sortie 2 enregistrée',
      timeEntryRegistered: 'Enregistrement d\'heure',
    ...
    irregularidades: {
      ...
      subtitulo: 'Aperçu des retards, absences et incohérences',
      atrasos: 'Retards',
      faltas: 'Absences',
      faltaSingular: 'absence',
      faltaPlural: 'absences',
      saidasAntecipadas: 'Départs Anticipés',
      horasExtras: 'Heures Supplémentaires',
      semPontoHoje: 'Pas de pointage aujourd\'hui',
      todosComPonto: 'Tous les employés ont pointé aujourd\'hui',
      rankingFaltas: 'Classement des Absences',
      rankingAtrasos: 'Classement des Retards',
      semFaltas: 'Aucune absence sur la période',
    ...
    exportacao: {
      ...
      excelChartTip: 'Astuce : Sélectionnez les colonnes Statut et Quantité ci-dessus et créez un Graphique Circulaire !',
      totalHoursSummary: 'Résumé Total des Heures',
      tip: 'Astuce',
      pdfErrorTip: 'Si l\'erreur persiste, vérifiez votre connexion internet et réessayez. Pour plus d\'informations, consultez le code d\'erreur dans la documentation.',
      observations: 'Observations',
    ...
    batida: {
      titulo: 'Pointage',
      subtitulo: 'Enregistrez votre entrée et sortie',
      iniciarJornada: 'Commencer la Journée',
      registrarPausa: 'Pause',
      ouEncerrar: 'ou terminer la journée',
      retomar: 'Reprendre',
      encerrarJornada: 'Terminer la Journée',
      jornadaEncerrada: 'Journée Terminée',
      aguardandoInicio: 'En attente du début de journée',
      emTrabalho: 'En travail',
      emPausa: 'En pause',
      jornadaFinalizada: 'Journée terminée',
      trabalhado: 'Travaillé',
      pausas: 'Pauses',
      registrosHoje: 'Enregistrements d\'Aujourd\'hui',
      entrada: 'Entrée',
      pausa: 'Pause',
      retorno: 'Reprise',
      saida: 'Sortie',
      entradaSucesso: 'Entrée enregistrée avec succès !',
      pausaSucesso: 'Pause enregistrée avec succès !',
      retornoSucesso: 'Reprise enregistrée avec succès !',
      saidaSucesso: 'Sortie enregistrée avec succès !',
      erroGenerico: 'Erreur lors de l\'enregistrement du pointage',
      geoError: 'Impossible de capturer la localisation. Le pointage sera enregistré sans GPS.',
