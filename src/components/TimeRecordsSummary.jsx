  ...
  return <div className="yt-card p-6 mb-6">
      ...
      {showDetails && <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
          ...
          <div className="space-y-3 max-h-64 overflow-y-auto">
            {timeRecords.map((record, index) => <div key={record.id || index} className="flex items-center justify-between p-3 yt-inset rounded-lg border border-gray-200/80 dark:border-gray-700/80">
