...
const ProjetoCardSkeleton = () => {
  return <div className="bg-white rounded-lg shadow-md border border-gray-300 p-6 overflow-hidden relative">
...
const GerenciamentoProjetosSkeleton = () => {
  return <div>
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        {[...Array(5)].map((_, index) => <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 overflow-hidden relative">
