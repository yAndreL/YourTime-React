...
function FormularioPonto() {
  ...
  return <MainLayout title={t('timeRecordForm.title')} subtitle={usuarioAtual ? `${t('timeRecordForm.hello')}, ${usuarioAtual.nome}` : ''}>
      {projetoSelecionado && <div className="mb-4 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg">
      ...
      {!projetoSelecionado && <div className="mb-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-lg flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="date" id="data" name="data" value={formData.data} onChange={handleChange} max={getLocalDateString()} className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm text-sm" required />
                </div>
                <div>
                  <label htmlFor="observacao" className="block text-sm font-semibold text-gray-700 mb-1">
                    {t('timeRecordForm.observation')}
                  </label>
                  <input type="text" id="observacao" name="observacao" value={formData.observacao} onChange={handleChange} placeholder={t('timeRecordForm.observationPlaceholder')} className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm placeholder:text-gray-400 text-sm" />
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="time" id="entrada1" name="entrada1" value={formData.entrada1} onChange={handleChange} placeholder="HH:MM" className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm text-sm" required />
                  </div>
                  <div>
                    <label htmlFor="saida1" className="block text-xs font-medium text-gray-700 mb-1">
                      {t('timeRecordForm.exit')}
                    </label>
                    <input type="time" id="saida1" name="saida1" value={formData.saida1} onChange={handleChange} placeholder="HH:MM" className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm text-sm" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="time" id="entrada2" name="entrada2" value={formData.entrada2} onChange={handleChange} placeholder="HH:MM" className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent shadow-sm text-sm" />
                  </div>
                  <div>
                    <label htmlFor="saida2" className="block text-xs font-medium text-gray-700 mb-1">
                      {t('timeRecordForm.exit')}
                    </label>
                    <input type="time" id="saida2" name="saida2" value={formData.saida2} onChange={handleChange} placeholder="HH:MM" className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent shadow-sm text-sm" />
                  </div>
                </div>
              </div>
              ...
              {erro && <div className="bg-red-50 border-l-4 border-red-500 text-red-700 px-3 py-2 rounded-lg flex items-center gap-2 text-sm">
                  <FiAlertCircle className="w-4 h-4 flex-shrink-0" />
                  <span>{erro}</span>
                </div>}

              {sucesso && <div className="bg-green-50 border-l-4 border-green-500 text-green-700 px-3 py-2 rounded-lg flex items-center gap-2 text-sm">
                  <FiCheckCircle className="w-4 h-4 flex-shrink-0" />
                  <span>{sucesso}</span>
                </div>}

              <div className="flex flex-col-reverse md:flex-row gap-2 pt-2">
                <button type="button" onClick={() => navigate('/')} className="flex-1 px-4 py-2.5 bg-white text-gray-700 border-2 border-gray-300 rounded-lg font-medium hover:bg-gray-50 hover:border-gray-400 transition-colors flex items-center justify-center gap-2 text-sm">
